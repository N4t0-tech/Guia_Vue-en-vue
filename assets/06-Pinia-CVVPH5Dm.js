import{t as e}from"./CodeBlock-DpXj1NaB.js";import{F as t,M as n,R as r,_ as i,d as a,f as o,h as s,n as c,p as l,v as u,w as d,y as f}from"./index-OKjGQV9p.js";var p=c(`counter`,()=>{let e=n(0),t=o(()=>e.value*2);function r(){e.value++}function i(){e.value--}function a(){e.value=0}return{count:e,double:t,increment:r,decrement:i,reset:a}}),m={class:`demo`},h={style:{display:`flex`,gap:`1rem`,"align-items":`center`,"flex-wrap":`wrap`}},g={style:{"font-size":`2rem`,"font-weight":`700`,"min-width":`3rem`,"text-align":`center`}},_={style:{"margin-top":`0.5rem`}},v={class:`demo`},y=`import { defineStore } from 'pinia'
