import{t as e}from"./CodeBlock-DSd9V9-T.js";import{A as t,E as n,L as r,M as i,R as a,_ as o,d as s,f as c,g as l,h as u,i as d,k as f,m as p,p as m,s as h,t as g,u as _,v,w as y,x as b,y as x}from"./index-DuKBGh4e.js";var S={class:`demo`},C={style:{display:`flex`,"align-items":`center`,gap:`0.5rem`,"margin-bottom":`0.5rem`}},w={class:`badge`},T={key:0,style:{"font-size":`0.85rem`}},E={key:1,style:{color:`var(--accent)`,"font-size":`0.85rem`}},D=[`checked`,`onChange`],O={style:{flex:`1`,"font-size":`0.9rem`,"text-decoration":`task.completed ? 'line-through' : 'none'`}},k=[`onClick`],A={key:2,style:{"margin-top":`1rem`,"text-align":`center`,opacity:`0.6`}},j=`// stores/tasks.ts
